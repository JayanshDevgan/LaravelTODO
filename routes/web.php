...
Route::get('/TODO-Graph', [TodoController::class, "graph"]);
Route::get('/TODO-Notes', [TodoController::class, "notes"]);
...
Route::get('/TODO-Organizer', [TodoController::class, "organizer"]);
Route::get('TODO-Script/convert', [TodoController::class, "convert"]);
